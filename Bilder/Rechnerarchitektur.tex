...
\draw[->, class1] (R1) -| (-6, 4.3); %R1-Wagen
\draw[->, class1] (-1, 2) -| (-6, 3.3); %R2 - Wagen
\draw[<-, class1] (-0.5, 5) |- (-6, 3.9); %Wagen -R2
\draw[<-, class1] (-0.5, 2.5) |- (-6, 3.6); %Wagen-R!
...
%Wagen
\node[gray] (SAK1) at (-7, 3.7) {Sensoren};
\node[gray] (SAK2) at (-7, 3.2) {Aktoren};
\node[gray] (SAK3) at (-7, 4.2) {Kommunikation};
