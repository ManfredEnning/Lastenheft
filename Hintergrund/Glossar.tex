...
\newglossaryentry{ep-assist-Bremsen}{
    name=ep-assist-Bremsen,
    description={ep-assist-Bremsen ist eine begrenzte Funktion des ep-Bremsen. Die Funktion beschränkt sich auf das unterstützte Bremsen wie bei wie bei \gls{ep-Bremsen} und beinhaltet kein ep-lösen}
}
\newglossaryentry{EOW}{
    name=EOW,
...
\newglossaryentry{Bremse 4.0}{
    name=Bremse40,
    description={Die Bremse wird als eine der \gls{40-Komponenten} des \gls{Gueterwagen 40} mit Besonderheiten zur Verkürzung der Vorbereitungszeit der Güterwagen}
}
