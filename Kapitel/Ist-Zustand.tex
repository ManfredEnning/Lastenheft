...
\begin{itemize}
	...
	\item Eigene (zum \gls{Gleisanschluss} zugehörene) Rangierlokomotive
...
Vor Beginn der Rangier-/\gls{Sperrfahrt} sind ggf. Bremsstellungen %prüfen
und Lastwechseleinstellungen zu prüfen und eine Sichtprüfung (\acrshort{twb} Stufe 1 (Siehe dazu auch Anhang \ref{sec:ATWb})) der Wagen durchzuführen. 
...
Angekommen am Gleisanschluss müssen einzelne Wagen wieder aus dem Zugverband rausgangiert oder zumindest abgekuppelt werden. Hier muss neben des Umsetzten des Zugschlusssignals auch eine neue Bremsprobe incl. Bremsberechnung durchgeführt werden.
